...
from helper_functions.compare_holders import compare_holders
...
for file in solscan_files:
    ...
    matches = compare_holders(photon_df, token_holders_df)
...
notes_df.to_csv(f'photon_notes/{timestamp}_notes.csv', index=False)
